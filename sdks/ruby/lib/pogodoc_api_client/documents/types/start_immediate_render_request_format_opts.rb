...
require_relative "start_immediate_render_request_format_opts_format"
require "ostruct"
require "json"

module PogodocApiClient
  class Documents
    class StartImmediateRenderRequestFormatOpts
      # @return [Float]
      attr_reader :from_page
      # @return [Float]
      attr_reader :to_page
      # @return [PogodocApiClient::Documents::StartImmediateRenderRequestFormatOptsFormat]
      attr_reader :format
      # @return [String]
      ...
      # @param to_page [Float]
      # @param format [PogodocApiClient::Documents::StartImmediateRenderRequestFormatOptsFormat]
      # @param wait_for_selector [String]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [PogodocApiClient::Documents::StartImmediateRenderRequestFormatOpts]
      ...
      # Serialize an instance of StartImmediateRenderRequestFormatOpts to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.format&.is_a?(PogodocApiClient::Documents::StartImmediateRenderRequestFormatOptsFormat) != false || raise("Passed value for field obj.format is not the expected type, validation failed.")
