...
module PogodocApiClient
  class Render
    class GetJobStatusResponse
      # @return [PogodocApiClient::Render::GetJobStatusResponseType]
      attr_reader :type
      # @return [String]
      attr_reader :job_id
      # @return [PogodocApiClient::Render::GetJobStatusResponseTarget]
      attr_reader :target
      # @return [PogodocApiClient::Render::GetJobStatusResponseOutput]
      attr_reader :output
      # @return [Boolean]
      attr_reader :success
      # @return [String]
      ...
      # @param type [PogodocApiClient::Render::GetJobStatusResponseType]
      # @param job_id [String]
      # @param target [PogodocApiClient::Render::GetJobStatusResponseTarget]
      # @param output [PogodocApiClient::Render::GetJobStatusResponseOutput]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["output"].nil?
          ...
          output = PogodocApiClient::Render::GetJobStatusResponseOutput.from_json(json_object: output)
        end
      ...
      def self.validate_raw(obj:)
        obj.type.is_a?(PogodocApiClient::Render::GetJobStatusResponseType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
        obj.job_id.is_a?(String) != false || raise("Passed value for field obj.job_id is not the expected type, validation failed.")
        obj.target.is_a?(PogodocApiClient::Render::GetJobStatusResponseTarget) != false || raise("Passed value for field obj.target is not the expected type, validation failed.")
        obj.output.nil? || PogodocApiClient::Render::GetJobStatusResponseOutput.validate_raw(obj: obj.output)
