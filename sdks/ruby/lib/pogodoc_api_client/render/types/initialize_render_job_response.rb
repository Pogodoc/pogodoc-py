...
module PogodocApiClient
  class Render
    class InitializeRenderJobResponse
      # @return [String]
      attr_reader :job_id
      # @return [PogodocApiClient::Render::InitializeRenderJobResponseTarget]
      attr_reader :target
      # @return [String]
      ...
      # @param job_id [String]
      # @param target [PogodocApiClient::Render::InitializeRenderJobResponseTarget]
      ...
      def self.validate_raw(obj:)
        ...
        obj.target.is_a?(PogodocApiClient::Render::InitializeRenderJobResponseTarget) != false || raise("Passed value for field obj.target is not the expected type, validation failed.")
