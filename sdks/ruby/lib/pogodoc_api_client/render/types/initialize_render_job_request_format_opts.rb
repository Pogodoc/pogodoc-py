...
require_relative "initialize_render_job_request_format_opts_format"
require "ostruct"
require "json"
...
module PogodocApiClient
  class Render
    class InitializeRenderJobRequestFormatOpts
      ...
      # @return [Float]
      attr_reader :to_page
      # @return [PogodocApiClient::Render::InitializeRenderJobRequestFormatOptsFormat]
      attr_reader :format
      # @return [String]
      ...
      # @param to_page [Float]
      # @param format [PogodocApiClient::Render::InitializeRenderJobRequestFormatOptsFormat]
      # @param wait_for_selector [String]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [PogodocApiClient::Render::InitializeRenderJobRequestFormatOpts]
      ...
      # Deserialize a JSON object to an instance of InitializeRenderJobRequestFormatOpts
      #
      ...
      # Serialize an instance of InitializeRenderJobRequestFormatOpts to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.format&.is_a?(PogodocApiClient::Render::InitializeRenderJobRequestFormatOptsFormat) != false || raise("Passed value for field obj.format is not the expected type, validation failed.")
