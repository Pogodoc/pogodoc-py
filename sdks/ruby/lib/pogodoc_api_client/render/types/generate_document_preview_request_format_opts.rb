...
module PogodocApiClient
  class Render
    class GenerateDocumentPreviewRequestFormatOpts
      ...
      # @return [Float]
      attr_reader :to_page
      # @return [PogodocApiClient::Render::GenerateDocumentPreviewRequestFormatOptsFormat]
      attr_reader :format
      # @return [String]
      ...
      # @param to_page [Float]
      # @param format [PogodocApiClient::Render::GenerateDocumentPreviewRequestFormatOptsFormat]
      # @param wait_for_selector [String]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [PogodocApiClient::Render::GenerateDocumentPreviewRequestFormatOpts]
      ...
      def self.validate_raw(obj:)
        ...
        obj.format&.is_a?(PogodocApiClient::Render::GenerateDocumentPreviewRequestFormatOptsFormat) != false || raise("Passed value for field obj.format is not the expected type, validation failed.")
