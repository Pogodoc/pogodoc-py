...
require_relative "generate_template_previews_request_format_opts_format"
require "ostruct"
require "json"
...
module PogodocApiClient
  class Templates
    ...
    class GenerateTemplatePreviewsRequestFormatOpts
      # @return [Float]
      attr_reader :from_page
      # @return [Float]
      attr_reader :to_page
      # @return [PogodocApiClient::Templates::GenerateTemplatePreviewsRequestFormatOptsFormat]
      attr_reader :format
      ...
      # @param to_page [Float]
      # @param format [PogodocApiClient::Templates::GenerateTemplatePreviewsRequestFormatOptsFormat]
      ...
      # @return [PogodocApiClient::Templates::GenerateTemplatePreviewsRequestFormatOpts]
      ...
      # Serialize an instance of GenerateTemplatePreviewsRequestFormatOpts to a JSON
      #  object
      #
      # @return [String]
      def to_json(*_args)
      ...
      def self.validate_raw(obj:)
        ...
        obj.format&.is_a?(PogodocApiClient::Templates::GenerateTemplatePreviewsRequestFormatOptsFormat) != false || raise("Passed value for field obj.format is not the expected type, validation failed.")
