...
module PogodocApiClient
  class Templates
    class SaveCreatedTemplateRequestPreviewIds
      ...
      # @return [PogodocApiClient::Templates::SaveCreatedTemplateRequestPreviewIds]
      ...
      # Deserialize a JSON object to an instance of SaveCreatedTemplateRequestPreviewIds
      #
      ...
      # Serialize an instance of SaveCreatedTemplateRequestPreviewIds to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
