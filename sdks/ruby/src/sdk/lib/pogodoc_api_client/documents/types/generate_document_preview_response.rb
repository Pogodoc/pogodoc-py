...
module PogodocApiClient
  class Documents
    class GenerateDocumentPreviewResponse
      # @return [String]
      attr_reader :url
      # @return [String]
      attr_reader :job_id
      ...
      # Deserialize a JSON object to an instance of GenerateDocumentPreviewResponse
      #
      ...
      # Serialize an instance of GenerateDocumentPreviewResponse to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
