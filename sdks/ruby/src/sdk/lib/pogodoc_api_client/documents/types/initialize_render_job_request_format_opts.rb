  ...
  class Documents
    class InitializeRenderJobRequestFormatOpts
      ...
      def self.validate_raw(obj:)
        ...
        obj.format&.is_a?(PogodocApiClient::Documents::InitializeRenderJobRequestFormatOptsFormat) != false || raise("Passed value for field obj.format is not the expected type, validation failed.")
