...
@JsonDeserialize(
    builder = InitializeRenderJobRequestFormatOpts.Builder.class
)
public final class InitializeRenderJobRequestFormatOpts {
  private final Optional<Double> fromPage;

  private final Optional<Double> toPage;

  private final Optional<InitializeRenderJobRequestFormatOptsFormat> format;

  private final Optional<String> waitForSelector;

  private final Map<String, Object> additionalProperties;

  private InitializeRenderJobRequestFormatOpts(Optional<Double> fromPage, Optional<Double> toPage,
      Optional<InitializeRenderJobRequestFormatOptsFormat> format, Optional<String> waitForSelector,
  ...
  @JsonProperty("format")
  public Optional<InitializeRenderJobRequestFormatOptsFormat> getFormat() {
    return format;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof InitializeRenderJobRequestFormatOpts && equalTo((InitializeRenderJobRequestFormatOpts) other);
  }
  ...
  private boolean equalTo(InitializeRenderJobRequestFormatOpts other) {
  ...
  public static final class Builder {
    ...
    private Optional<InitializeRenderJobRequestFormatOptsFormat> format = Optional.empty();
    ...
    public Builder from(InitializeRenderJobRequestFormatOpts other) {
    ...
    public Builder format(Optional<InitializeRenderJobRequestFormatOptsFormat> format) {
      this.format = format;
      return this;
    }

    public Builder format(InitializeRenderJobRequestFormatOptsFormat format) {
    ...
    public InitializeRenderJobRequestFormatOpts build() {
      return new InitializeRenderJobRequestFormatOpts(fromPage, toPage, format, waitForSelector, additionalProperties);
    }
  }
}
