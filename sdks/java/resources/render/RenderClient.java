...
public class RenderClient {
  ...
  private final RawRenderClient rawClient;

  public RenderClient(ClientOptions clientOptions) {
    this.clientOptions = clientOptions;
    this.rawClient = new RawRenderClient(clientOptions);
  }

  /**
   * Get responses with HTTP metadata like headers
   */
  public RawRenderClient withRawResponse() {
