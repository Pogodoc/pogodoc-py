...
@JsonDeserialize(
    builder = GenerateTemplatePreviewsRequestFormatOpts.Builder.class
)
public final class GenerateTemplatePreviewsRequestFormatOpts {
  private final Optional<Double> fromPage;

  private final Optional<Double> toPage;

  private final Optional<GenerateTemplatePreviewsRequestFormatOptsFormat> format;

  private final Optional<String> waitForSelector;

  private final Map<String, Object> additionalProperties;

  private GenerateTemplatePreviewsRequestFormatOpts(Optional<Double> fromPage,
      Optional<Double> toPage, Optional<GenerateTemplatePreviewsRequestFormatOptsFormat> format,
  ...
  @JsonProperty("format")
  public Optional<GenerateTemplatePreviewsRequestFormatOptsFormat> getFormat() {
    return format;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof GenerateTemplatePreviewsRequestFormatOpts && equalTo((GenerateTemplatePreviewsRequestFormatOpts) other);
  }
  ...
  private boolean equalTo(GenerateTemplatePreviewsRequestFormatOpts other) {
  ...
  public static final class Builder {
    ...
    private Optional<GenerateTemplatePreviewsRequestFormatOptsFormat> format = Optional.empty();
    ...
    public Builder from(GenerateTemplatePreviewsRequestFormatOpts other) {
    ...
    public Builder format(Optional<GenerateTemplatePreviewsRequestFormatOptsFormat> format) {
      this.format = format;
      return this;
    }

    public Builder format(GenerateTemplatePreviewsRequestFormatOptsFormat format) {
    ...
    public GenerateTemplatePreviewsRequestFormatOpts build() {
      return new GenerateTemplatePreviewsRequestFormatOpts(fromPage, toPage, format, waitForSelector, additionalProperties);
    }
  }
}
