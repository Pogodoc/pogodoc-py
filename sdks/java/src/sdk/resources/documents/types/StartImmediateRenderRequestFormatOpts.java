...
@JsonDeserialize(
    builder = StartImmediateRenderRequestFormatOpts.Builder.class
)
public final class StartImmediateRenderRequestFormatOpts {
  private final Optional<Double> fromPage;

  private final Optional<Double> toPage;

  private final Optional<StartImmediateRenderRequestFormatOptsFormat> format;

  private final Optional<String> waitForSelector;

  private final Map<String, Object> additionalProperties;

  private StartImmediateRenderRequestFormatOpts(Optional<Double> fromPage, Optional<Double> toPage,
      Optional<StartImmediateRenderRequestFormatOptsFormat> format,
  ...
  @JsonProperty("format")
  public Optional<StartImmediateRenderRequestFormatOptsFormat> getFormat() {
    return format;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof StartImmediateRenderRequestFormatOpts && equalTo((StartImmediateRenderRequestFormatOpts) other);
  }
  ...
  private boolean equalTo(StartImmediateRenderRequestFormatOpts other) {
  ...
  public static final class Builder {
    ...
    private Optional<StartImmediateRenderRequestFormatOptsFormat> format = Optional.empty();
    ...
    public Builder from(StartImmediateRenderRequestFormatOpts other) {
    ...
    public Builder format(Optional<StartImmediateRenderRequestFormatOptsFormat> format) {
      this.format = format;
      return this;
    }

    public Builder format(StartImmediateRenderRequestFormatOptsFormat format) {
    ...
    public StartImmediateRenderRequestFormatOpts build() {
      return new StartImmediateRenderRequestFormatOpts(fromPage, toPage, format, waitForSelector, additionalProperties);
    }
  }
}
