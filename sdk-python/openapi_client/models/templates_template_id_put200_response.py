...
class TemplatesTemplateIdPut200Response(BaseModel):
    """
    TemplatesTemplateIdPut200Response
    """ # noqa: E501
    new_content_id: StrictStr = Field(alias="newContentId")
    __properties: ClassVar[List[str]] = ["newContentId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "newContentId": obj.get("newContentId")
        })
        return _obj
