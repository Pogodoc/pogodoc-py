...
class TemplatesTemplateIdIndexHtmlGet200Response(BaseModel):
    """
    TemplatesTemplateIdIndexHtmlGet200Response
    """ # noqa: E501
    template_index: StrictStr = Field(alias="templateIndex")
    __properties: ClassVar[List[str]] = ["templateIndex"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "templateIndex": obj.get("templateIndex")
        })
        return _obj
