...
class TemplatesTemplateIdClonePost200Response(BaseModel):
    """
    TemplatesTemplateIdClonePost200Response
    """ # noqa: E501
    new_template_id: StrictStr = Field(alias="newTemplateId")
    __properties: ClassVar[List[str]] = ["newTemplateId"]
