...
class TemplatesInitGet200Response(BaseModel):
    """
    TemplatesInitGet200Response
    """ # noqa: E501
    job_id: StrictStr = Field(alias="jobId")
    presigned_template_upload_url: StrictStr = Field(alias="presignedTemplateUploadUrl")
    __properties: ClassVar[List[str]] = ["jobId", "presignedTemplateUploadUrl"]
