...
class TemplatesTemplateIdPutRequestAllOfPreviewIds(BaseModel):
    """
    TemplatesTemplateIdPutRequestAllOfPreviewIds
    """ # noqa: E501
    png_job_id: StrictStr = Field(alias="pngJobId")
    pdf_job_id: StrictStr = Field(alias="pdfJobId")
    __properties: ClassVar[List[str]] = ["pngJobId", "pdfJobId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pngJobId": obj.get("pngJobId"),
            "pdfJobId": obj.get("pdfJobId")
        })
        return _obj
