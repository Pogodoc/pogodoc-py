...
class JobsJobIdGet200ResponseOutputMetadata(BaseModel):
    """
    JobsJobIdGet200ResponseOutputMetadata
    """ # noqa: E501
    render_time: Union[StrictFloat, StrictInt] = Field(alias="renderTime")
    __properties: ClassVar[List[str]] = ["renderTime"]
