...
class TestTemplatesTemplateIdPutRequest(unittest.TestCase):
    """TemplatesTemplateIdPutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplatesTemplateIdPutRequest:
        """Test TemplatesTemplateIdPutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplatesTemplateIdPutRequest`
        """
        model = TemplatesTemplateIdPutRequest()
        if include_optional:
            return TemplatesTemplateIdPutRequest(
    ...
    def testTemplatesTemplateIdPutRequest(self):
        """Test TemplatesTemplateIdPutRequest"""
